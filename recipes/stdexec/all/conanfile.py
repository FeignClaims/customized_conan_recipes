...
class StdexecConan(ConanFile):
    ...
    def build_requirements(self):
        self.tool_requires("cmake/[>=3.22.1 <4.0.0]")
    ...
    def generate(self):
        ...
        toolchain.cache_variables["STDEXEC_BUILD_EXAMPLES"] = False
        toolchain.cache_variables["STDEXEC_BUILD_TESTS"] = not self.conf.get(
